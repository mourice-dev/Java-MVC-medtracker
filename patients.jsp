                                                            ...
                                                            <% String filterDateFrom=request.getParameter("dateFrom");
                                                                ...
                                                                <% if (searchKeyword !=null && !searchKeyword.isEmpty())
                                                                    ...
                                                                    <% } %>
                                                                        ...
                                                                        <div>
                                                                            <label
                                                                                class="block text-xs font-medium text-slate-500 mb-1">From
                                                                                Date</label>
                                                                            <input type="date" name="dateFrom"
                                                                                value="<%= filterDateFrom != null ? filterDateFrom : "" %>"
                                                                                class="w-full p-2 border rounded-lg text-sm focus:outline-none focus:border-teal-500">
                                                                        </div>
                                                                        <div>
                                                                            <label
                                                                                class="block text-xs font-medium text-slate-500 mb-1">To
                                                                                Date</label>
                                                                        ...
                                                                        <div>
                                                                            <label
                                                                                class="block text-xs font-medium text-slate-500 mb-1">Status</label>
                                                                            <select name="status"
                                                                                class="w-full p-2 border rounded-lg text-sm focus:outline-none focus:border-teal-500 bg-white">
                                                                        ...
                                                                        <div class="flex items-end gap-2">
                                                                            <button type="submit"
                                                                                class="flex-1 bg-slate-800 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-900 transition">Filter</button>
                                                                            <a href="patients"
                                                                                class="bg-slate-100 text-slate-600 px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-200 transition">Reset</a>
                                                                        </div>
                                                        </form>
                                                    </div>
